...
class UchoaStrategy(IStrategy):
    """
    ML-enhanced scalping strategy trained on 6 years of data (2020-2026).
    90%+ win rate validated out-of-sample on 2025-2026 test set.

    Core: enter in confirmed uptrend, ML model filters entries,
    let ROI/trailing stop handle exits (no exit signal to avoid premature exits).
    """
